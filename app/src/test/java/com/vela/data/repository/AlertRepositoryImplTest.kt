...
class AlertRepositoryImplTest {
    ...
    @Test
    fun `observeAlertsByCoinId maps entities to domain models`() =
        runTest {
    ...
    @Test
    fun `createAlert calls dao insert with correct entity`() =
        runTest {
    ...
    @Test
    fun `updateAlert calls dao update with correct entity`() =
        runTest {
    ...
    @Test
    fun `deleteAlert calls dao delete with correct id`() =
        runTest {
