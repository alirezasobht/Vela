...
class SafeApiCallTest {
    ...
    @Test
    fun `successful API call returns Success`() =
        runTest {
    ...
    @Test
    fun `HttpException maps to ServerError`() =
        runTest {
            val result =
                safeApiCall {
    ...
    @Test
    fun `Exception with message maps to Unknown with that message`() =
        runTest {
    ...
    @Test
    fun `Exception with null message maps to Unknown with fallback`() =
        runTest {
