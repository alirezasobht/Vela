...
class GetWatchlistAssetsUseCaseTest {
    ...
    @Test
    fun `empty watchlist emits empty success without calling getAssetsByIds`() =
        runTest {
    ...
    @Test
    fun `non-empty watchlist calls getAssetsByIds with correct ids`() =
        runTest {
    ...
    @Test
    fun `getAssetsByIds error propagates`() =
        runTest {
    ...
    @Test
    fun `watchlist change re-fetches with new ids`() =
        runTest {
