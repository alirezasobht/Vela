...
class GetTopAssetsUseCaseTest {
    ...
    @Test
    fun `invoke with default limit value`() =
        runTest {
    ...
    @Test
    fun `invoke with custom positive limit`() =
        runTest {
    ...
    @Test
    fun `invoke with zero limit boundary`() =
        runTest {
    ...
    @Test
    fun `invoke with negative limit value`() =
        runTest {
    ...
    @Test
    fun `invoke with maximum integer limit`() =
        runTest {
    ...
    @Test
    fun `successful repository emission with data`() =
        runTest {
    ...
    @Test
    fun `successful repository emission with empty list`() =
        runTest {
    ...
    @Test
    fun `repository emission with failure result`() =
        runTest {
    ...
    @Test
    fun `repository throws immediate exception`() =
        runTest {
