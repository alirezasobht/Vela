...
fun Asset.toUiModel(): AssetUiModel =
    AssetUiModel(
        id = id,
        name = name,
        image = image ?: "",
...
fun SimplePrice.toUiModel(): SimplePriceUiModel =
    SimplePriceUiModel(
...
internal fun formatPrice(
    ...
    val formatted =
        DecimalFormat(pattern, symbols).format(
...
internal fun formatLargeNumber(value: Double): String =
    when {
