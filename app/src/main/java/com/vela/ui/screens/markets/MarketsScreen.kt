...
internal data class MarketActions(val onCategorySelected: (MarketCategory) -> Unit, val onSortSelected: (MarketSort) -> Unit, val onRetry: () -> Unit, val assetListItemActions: AssetListItemActions)
...
private fun SuccessState(
    ...
    PagedAssetList(
        ...
        actions = marketAction.assetListItemActions,
        modifier = modifier.fillMaxSize()
    )
}
    ...
    LazyColumn(modifier = modifier.fillMaxSize()) {
        items(
            ...
            pagingItems[index]?.let { asset ->
                AssetListItem(asset = asset, actions = actions)
