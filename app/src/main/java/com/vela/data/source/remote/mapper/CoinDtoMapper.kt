...
fun CoinDto.toEntity(): AssetEntity =
    AssetEntity(
        id = id,
        symbol = symbol,
        name = name,
...
fun SearchCoinDto.toDomain(): Asset =
    Asset(
        id = id,
        symbol = symbol,
        name = name,
...
fun CategoryDto.toDomain(): MarketCategory =
    MarketCategory(
        id = id,
        displayName = name
    )

fun SimplePriceDto.toDomain(): SimplePrice =
    SimplePrice(
        price = usd,
...
fun List<Double>.toOhlcPoint(): OhlcPoint =
    OhlcPoint(
